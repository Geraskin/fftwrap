...
namespace FftWrap
{
    ...
    public static partial class Fftwf
    {
        ...
        public static extern IntPtr PlanDft(int rank, IntPtr n, IntPtr src, IntPtr dst, int sign, uint flags);
        ...
        public static extern IntPtr PlanManyDft(int rank, IntPtr n, int howMany, IntPtr src, IntPtr inembed, int istride, int idist, IntPtr dst, IntPtr onembed, int ostride, int odist, int sign, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru_dft")]
        public static extern IntPtr PlanGuruDft(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr dst, int sign, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru_split_dft")]
        public static extern IntPtr PlanGuruSplitDft(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr ri, IntPtr ii, IntPtr ro, IntPtr io, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru64_dft")]
        public static extern IntPtr PlanGuru64Dft(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr dst, int sign, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru64_split_dft")]
        public static extern IntPtr PlanGuru64SplitDft(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr ri, IntPtr ii, IntPtr ro, IntPtr io, uint flags);
        ...
        public static extern IntPtr PlanManyDftR2c(int rank, IntPtr n, int howMany, IntPtr src, IntPtr inembed, int istride, int idist, IntPtr dst, IntPtr onembed, int ostride, int odist, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_dft_r2c")]
        public static extern IntPtr PlanDftR2c(int rank, IntPtr n, IntPtr src, IntPtr dst, uint flags);
        ...
        public static extern IntPtr PlanManyDftC2r(int rank, IntPtr n, int howMany, IntPtr src, IntPtr inembed, int istride, int idist, IntPtr dst, IntPtr onembed, int ostride, int odist, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_dft_c2r")]
        public static extern IntPtr PlanDftC2r(int rank, IntPtr n, IntPtr src, IntPtr dst, uint flags);
        ...
        public static extern IntPtr PlanGuruDftR2c(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr dst, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru_dft_c2r")]
        public static extern IntPtr PlanGuruDftC2r(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr dst, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru_split_dft_r2c")]
        public static extern IntPtr PlanGuruSplitDftR2c(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr ro, IntPtr io, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru_split_dft_c2r")]
        public static extern IntPtr PlanGuruSplitDftC2r(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr ri, IntPtr ii, IntPtr dst, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru64_dft_r2c")]
        public static extern IntPtr PlanGuru64DftR2c(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr dst, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru64_dft_c2r")]
        public static extern IntPtr PlanGuru64DftC2r(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr dst, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru64_split_dft_r2c")]
        public static extern IntPtr PlanGuru64SplitDftR2c(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr ro, IntPtr io, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru64_split_dft_c2r")]
        public static extern IntPtr PlanGuru64SplitDftC2r(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr ri, IntPtr ii, IntPtr dst, uint flags);
        ...
        public static extern IntPtr PlanManyR2r(int rank, IntPtr n, int howMany, IntPtr src, IntPtr inembed, int istride, int idist, IntPtr dst, IntPtr onembed, int ostride, int odist, IntPtr kind, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_r2r")]
        public static extern IntPtr PlanR2r(int rank, IntPtr n, IntPtr src, IntPtr dst, IntPtr kind, uint flags);
        ...
        public static extern IntPtr PlanGuruR2r(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr dst, IntPtr kind, uint flags);
        [DllImport(NativeDllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftwf_plan_guru64_r2r")]
        public static extern IntPtr PlanGuru64R2r(int rank, IntPtr dims, int howManyRank, IntPtr howManyDims, IntPtr src, IntPtr dst, IntPtr kind, uint flags);
        ...
        public static extern int ExportWisdomToFilename(IntPtr filename);
        ...
        public static extern int ImportWisdomFromFilename(IntPtr filename);
        ...
        public static extern int ImportWisdomFromString(IntPtr inputString);
